...
#sampler = OHEMPixelSampler(ignore_index=255)
#
#gt = torch.rand(3, 1, 225, 224)
#gt = gt * 255
#gt = gt.long()
#gt[gt < 50] = 0
#gt[(gt >= 50) & (gt < 200)] = 1
...
#predict = torch.randn(3, 7, 225, 224)

# seg_weight = sampler.sample(predict, gt)
# print(seg_weight.shape)
# print(torch.unique(seg_weight))
# print(seg_weight.shape)